...
describe('ActivitySearchComponent', () => {
  ...
  it('should call the activity search status and check if status is completed',()=>{
    ...
    activityService.searchstatus.and.callFake(()=>{
      return of(response);
    })
  ...
  it('should call activity search result function and get a valid response',()=>{
    ...
    activityService.searchresult.and.callFake(()=>{
      return of(response);
    })
...
//   let ActivityTabComponent: SearchComponent;
//   let fixture: ComponentFixture<SearchComponent>;
//  let service:jasmine.SpyObj<ActivitySearchService> = jasmine.createSpyObj("SearchService",["searchinit","searchstatus","searchresult"]);
...
//     fixture = TestBed.createComponent(SearchComponent);
//     ActivityTabComponent = fixture.componentInstance;
//     fixture.detectChanges();
//   });
...
//   it('should create', () => {
//     expect(ActivityTabComponent).toBeTruthy();
//   });
...
//   spyOn(ActivityTabComponent, 'searchstatus'); 
//   ActivityTabComponent.searchinit();
//   fixture.detectChanges();
//     expect(ActivityTabComponent.searchinit).toBe(response);
//   });
...
//    spyOn(ActivityTabComponent,'searchresult');
//    ActivityTabComponent.searchstatus();
//    fixture.detectChanges();
//    expect(response.status).toBe("Completed");
//   });
...
//      return of(response);
//    })
//    ActivityTabComponent.searchresult();
//    fixture.detectChanges();
//    expect(response.activities).toEqual(ActivityTabComponent.finalresult);    
//   });
