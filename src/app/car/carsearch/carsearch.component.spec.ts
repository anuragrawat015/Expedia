...
describe('carSearchComponent', () => {
  ...
  let carService : jasmine.SpyObj<CarsearchService> = jasmine.createSpyObj("carService",["searchinit","searchstatus","searchresult"]);
  // beforeEach(async () => {
  //   await TestBed.configureTestingModule({
  //     imports : [HttpClientTestingModule],
  //     declarations: [ CarsearchService ],
  //     providers : [
  //       {
  ...
  it('should call the car search-init and send valid response',()=>{
    ...
    carService.searchinit.and.callFake(()=>{
       return of(response);
    })
  ...
  it('should call the car search status and check if status is completed',()=>{
    ...
    carService.searchstatus.and.callFake(()=>{
      return of(response);
    })
  ...
  it('should call car search result function and get a valid response',()=>{
    ...
    carService.searchresult.and.callFake(()=>{
      return of(response);
    })
